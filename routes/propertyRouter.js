...
const addProjectSpendings = require("../controller/property/addProjectSpending");
...
propertyRouter.route("/:property_id").get(getPropertyByPropertyId).post(addProjectSpendings).all(methodNotAllowed);
